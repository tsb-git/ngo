    ...
    class l {
        ...
        setSelectedBy(e, t) {
            ...
            for (let o of this.data) {
                if (o instanceof n)
                    for (let n of o.options) s || (s = n), n.selected = !i && t.includes(n[e]), n.selected && (l.push(n), "single" === this.selectType && (i = !0));
        ...
        getOptgroupByID(e) {
            for (let t of this.data)
                if (t instanceof n && t.id === e) return t;
            return null
        }
        getOptionByID(e) {
        ...
        getFirstOption() {
            let e = null;
            for (let t of this.data)
                if (t instanceof n ? e = t.options[0] : t instanceof a && (e = t), e) break;
            return e
        }
        search(e, t) {
            ...
            if (s.classList.add(this.classes.valueText), s.textContent = e.text, t.appendChild(s), !e.mandatory) {
                ...
                s.classList.add(this.classes.valueDelete), s.onclick = t => {
                    ...
                    if (!(this.settings.minSelected && l.length < this.settings.minSelected) && (this.callbacks.beforeChange && (s = !0 === this.callbacks.beforeChange(l, i)), s)) {
                        ...
                        for (const t of l) {
                            if (t instanceof n)
                                for (const s of t.options) e.push(s.id);
        ...
        setSelected(e, t = !0) {
            ...
            for (const t of e)
                if (n.find((e => e.id == t))) a.push(t);
                    ...
                    for (const e of n.filter((e => e.value == t))) a.push(e.id);
